...
module domain
       ...
       integer, parameter :: nx_gl = 120 ! Number of grid points in X
       integer, parameter :: ny_gl = 120 ! Number of grid points in Y
       integer, parameter :: nz_gl = 512 ! Number of pressure (scalar) levels
       integer, parameter :: nsubdomains_x  = 6 ! No of subdomains in x
       integer, parameter :: nsubdomains_y  = 20 ! No of subdomains in y
